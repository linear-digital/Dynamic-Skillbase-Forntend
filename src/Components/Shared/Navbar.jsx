    ...
    return (
        <ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
            ...
            <Typography
                ...
                className="p-1 font-medium"
            >
                <Link to={'/blog'} href="#" className="flex items-center text-black text-base hover:text-primary transition-colors">
                    Blog
                </Link>
            </Typography>
            <Typography
...
export function TopNavbar() {
    ...
    return (
        <Navbar
            variant="filled"
            color="transparent"
            className="sticky top-0 z-10 h-max max-w-full rounded px-4 py-2 lg:px-8 lg:py-2 bg-white container mx-auto shadow-md">
